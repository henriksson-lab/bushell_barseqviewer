...
# POOL C1
################################################################################
filename1 = 'POOLC5_BL6_NP_VS_RAG1KO_NP_RGR_T_TEST_SUMMARY_PVAL_0.01.csv'
filename2 = 'POOLC5_BL6_P_VS_BL6_NP_RGR_T_TEST_SUMMARY_PVAL_0.01.csv'
filename3 = 'POOLC5_BL6_P_VS_RAG1KO_P_RGR_T_TEST_SUMMARY_PVAL_0.01.csv'
filename4 = 'POOLC5_RAG1KO_P_VS_RAG1KO_NP_RGR_T_TEST_SUMMARY_PVAL_0.01.csv'
################################################################################
...
app = dash.Dash(
  __name__,
  server=server,
  routes_pathname_prefix='/POOLC5_RAW_PVAL/')
...
def scatterplot(selected_gene):
    ...
    fig1 = px.scatter(DATA_PLOT1[DATA_PLOT1.gene_status.isin(['Not significant','significant',selected_gene])], x = 'rgr_bl6_np', y = 'rgr_rag1ko_np', color_discrete_map = color_discrete_map,
        hover_data = ['gene','pvalue','pvalue_corrected','pheno_bl6_np','pheno_rag1ko_np','rgr_bl6_np','rgr_bl6_np','gene_product','significant_status'], color = 'gene_status', labels={ "rgr_bl6_np": "Relative.Growth.Rate (BL6 NP)", "rgr_rag1ko_np": "Relative.Growth.Rate (RAG1KO NP)"}, title = title)
...
def scatterplot(selected_gene):
    ...
    fig3 = px.scatter(DATA_PLOT3[DATA_PLOT3.gene_status.isin(['Not significant','significant',selected_gene])], x = 'rgr_bl6_p', y = 'rgr_rag1ko_p', color_discrete_map = color_discrete_map,
        hover_data = ['gene','pvalue','pvalue_corrected','pheno_bl6_p','pheno_rag1ko_p','rgr_bl6_p','rgr_rag1ko_p','gene_product','significant_status'], color = 'gene_status', labels={ "rgr_bl6_p": "Relative.Growth.Rate (BL6 P)", "rgr_rag1ko_p": "Relative.Growth.Rate (RAG1KO P)"}, title = title)
...
def scatterplot(selected_gene):
    ...
    fig4 = px.scatter(DATA_PLOT4[DATA_PLOT4.gene_status.isin(['Not significant','significant',selected_gene])], x = 'rgr_RAG1KO_p', y = 'rgr_RAG1KO_np', color_discrete_map = color_discrete_map,
        hover_data = ['gene','pvalue','pvalue_corrected','pheno_RAG1KO_p','pheno_RAG1KO_np','rgr_RAG1KO_p','rgr_RAG1KO_np','gene_product','significant_status'], color = 'gene_status', labels={ "rgr_RAG1KO_p": "Relative.Growth.Rate (RAG1KO P)", "rgr_RAG1KO_np": "Relative.Growth.Rate (RAG1KO NP)"}, title = title)
...
if __name__ == '__main__':
    app.run_server(debug = True, port = 1124)
