...
app = dash.Dash(
  __name__,
  server=server,
  routes_pathname_prefix='/INTERFERON_WO_D7_RAW_PVAL/')
...
def scatterplot(selected_gene):
    ...
    fig1 = px.scatter(DATA_PLOT1[DATA_PLOT1.gene_status.isin(['Not significant','significant',selected_gene])], x = 'rgr_bl6_np', y = 'rgr_ifnyko_np', color_discrete_map = color_discrete_map,
        hover_data = ['gene','pvalue','pvalue_corrected','pheno_bl6_np','pheno_ifnyko_np','rgr_bl6_np','rgr_bl6_np','gene_product','significant_status'], color = 'gene_status', labels={ "rgr_bl6_np": "Relative.Growth.Rate (BL6 NP)", "rgr_ifnyko_np": "Relative.Growth.Rate (IFNYKO NP)"})
...
def scatterplot(selected_gene):
    ...
    fig3 = px.scatter(DATA_PLOT3[DATA_PLOT3.gene_status.isin(['Not significant','significant',selected_gene])], x = 'rgr_bl6_p', y = 'rgr_ifnyko_p', color_discrete_map = color_discrete_map,
        hover_data = ['gene','pvalue','pvalue_corrected','pheno_bl6_p','pheno_ifnyko_p','rgr_bl6_p','rgr_ifnyko_p','gene_product','significant_status'], color = 'gene_status', labels={ "rgr_bl6_p": "Relative.Growth.Rate (BL6 P)", "rgr_ifnyko_p": "Relative.Growth.Rate (IFNYKO P)"})
...
def scatterplot(selected_gene):
    ...
    fig4 = px.scatter(DATA_PLOT4[DATA_PLOT4.gene_status.isin(['Not significant','significant',selected_gene])], x = 'rgr_IFNYKO_p', y = 'rgr_IFNYKO_np', color_discrete_map = color_discrete_map,
        hover_data = ['gene','pvalue','pvalue_corrected','pheno_IFNYKO_p','pheno_IFNYKO_np','rgr_IFNYKO_p','rgr_IFNYKO_np','gene_product','significant_status'], color = 'gene_status', labels={ "rgr_IFNYKO_p": "Relative.Growth.Rate (IFNYKO P)", "rgr_IFNYKO_np": "Relative.Growth.Rate (IFNYKO NP)"})
...
if __name__ == '__main__':
    app.run_server(debug = True, port = 1983)
