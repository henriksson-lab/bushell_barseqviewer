...
# POOL C1
################################################################################
filename1 = 'ALL_BL6_NP_VS_IFNYKO_NP_RGR_T_TEST_SUMMARY_PVAL_0.01.csv'
filename2 = 'ALL_BL6_P_VS_BL6_NP_RGR_T_TEST_SUMMARY_PVAL_0.01.csv'
filename3 = 'ALL_BL6_P_VS_IFNYKO_P_RGR_T_TEST_SUMMARY_PVAL_0.01.csv'
filename4 = 'ALL_IFNYKO_P_VS_IFNYKO_NP_RGR_T_TEST_SUMMARY_PVAL_0.01.csv'
################################################################################
...
app = dash.Dash(
  __name__,
  server=server,
  routes_pathname_prefix='/INTERFERON_ALLDAYS_RAW_PVAL/')
...
def scatterplot(selected_gene):
    ...
    fig1 = px.scatter(DATA_PLOT1[DATA_PLOT1.gene_status.isin(['Not significant','significant',selected_gene])], x = 'rgr_bl6_np', y = 'rgr_ifnyko_np', color_discrete_map = color_discrete_map,
        hover_data = ['gene','pvalue','pvalue_corrected','pheno_bl6_np','pheno_ifnyko_np','rgr_bl6_np','rgr_bl6_np','gene_product','significant_status'], color = 'gene_status', labels={ "rgr_bl6_np": "Relative.Growth.Rate (BL6 NP)", "rgr_ifnyko_np": "Relative.Growth.Rate (IFNYKO NP)"}, title = title)
...
def scatterplot(selected_gene):
    ...
    title = " ".join(filename2.split(".")[0].split("_")[1:6])
    ...
    fig2 = px.scatter(DATA_PLOT2[DATA_PLOT2.gene_status.isin(['Not significant','significant',selected_gene])], x = 'rgr_bl6_np', y = 'rgr_bl6_p', color_discrete_map = color_discrete_map,
        hover_data = ['gene','pvalue','pvalue_corrected','pheno_bl6_np','pheno_bl6_p','rgr_bl6_np','rgr_bl6_p','gene_product','significant_status'], color = 'gene_status', labels={ "rgr_bl6_np": "Relative.Growth.Rate (BL6 NP)", "rgr_bl6_p": "Relative.Growth.Rate (BL6 P)"}, title = title)    
...
def scatterplot(selected_gene):
    ...
    #Create the basic plot
    fig3 = px.scatter(DATA_PLOT3[DATA_PLOT3.gene_status.isin(['Not significant','significant',selected_gene])], x = 'rgr_bl6_p', y = 'rgr_ifnyko_p', color_discrete_map = color_discrete_map,
        hover_data = ['gene','pvalue','pvalue_corrected','pheno_bl6_p','pheno_ifnyko_p','rgr_bl6_p','rgr_ifnyko_p','gene_product','significant_status'], color = 'gene_status', labels={ "rgr_bl6_p": "Relative.Growth.Rate (BL6 P)", "rgr_ifnyko_p": "Relative.Growth.Rate (IFNYKO P)"}, title = title)
...
def scatterplot(selected_gene):
    ...
    title = " ".join(filename4.split(".")[0].split("_")[1:6])
    #Create the basic plot
    fig4 = px.scatter(DATA_PLOT4[DATA_PLOT4.gene_status.isin(['Not significant','significant',selected_gene])], x = 'rgr_IFNYKO_p', y = 'rgr_IFNYKO_np', color_discrete_map = color_discrete_map,
        hover_data = ['gene','pvalue','pvalue_corrected','pheno_IFNYKO_p','pheno_IFNYKO_np','rgr_IFNYKO_p','rgr_IFNYKO_np','gene_product','significant_status'], color = 'gene_status', labels={ "rgr_IFNYKO_p": "Relative.Growth.Rate (IFNYKO P)", "rgr_IFNYKO_np": "Relative.Growth.Rate (IFNYKO NP)"}, title = title)
